...
export default function ResultadosRevelacao({ avaliacoes, media, imovel }: ResultadosRevelacaoProps) {
  return (
    <motion.div
      ...
      className="glass-strong rounded-2xl p-6 border border-emerald-500/30"
    >
        ...
        <AnimatePresence>
          {avaliacoes.map((avaliacao, index) => (
            ...
            >
              ...
              <span className="text-emerald-400 font-bold text-lg number-display">
      ...
      <motion.div
        ...
        className="relative bg-gradient-to-br from-emerald-500/20 to-emerald-600/20 rounded-2xl p-8 border-2 border-emerald-500/50"
      >
        <div className="absolute inset-0 bg-emerald-500/10 rounded-2xl animate-glow" />
        <div className="relative text-center">
          ...
          <motion.p
            ...
            className="text-5xl md:text-6xl font-bold text-emerald-400 number-display"
          >
